...
const getPlayByPlayRows = allPlays => {
  ...
  for (let i = 0; i < allPlays.length; i += 1) {
    ...
    const scoreboard = `${(0, _wideAlign.right)(home_score > (0, _get2.default)(allPlays[i + 1], 'home_score') ? (0, _log.bold)((0, _log.neonGreen)(home_score)) : (0, _log.bold)(home_score), 3)} - ${(0, _wideAlign.left)(visitor_score > (0, _get2.default)(allPlays[i + 1], 'visitor_score') ? (0, _log.bold)((0, _log.neonGreen)(visitor_score)) : (0, _log.bold)(visitor_score), 3)}`;
