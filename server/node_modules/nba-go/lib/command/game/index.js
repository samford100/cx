...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } /* eslint-disable no-await-in-loop, no-constant-condition */
...
const getGameWithOptionalFilter = (() => {
  var _ref = _asyncToGenerator(function* (games, filter) {
...
const game = (() => {
  var _ref2 = _asyncToGenerator(function* (option) {
    ...
    try {
      var _ref3 = yield _nbaStatsClient2.default.getGamesFromDate(new Date(_date));
    ...
    try {
      var _ref5 = yield _nbaStatsClient2.default.getBoxScoreFromDate(new Date(_date), gameData.id),
      ...
      case '1':
        {
          ...
          try {
            var _ref6 = yield _nba2.default.stats.teamSplits({
              Season: process.env.season,
              TeamID: homeTeam.getID()
            }),
                _ref6$overallTeamDash = _slicedToArray(_ref6.overallTeamDashboard, 1);

            const _homeTeamDashboardData = _ref6$overallTeamDash[0];

            var _ref7 = yield _nba2.default.stats.teamSplits({
              Season: process.env.season,
              TeamID: visitorTeam.getID()
            }),
                _ref7$overallTeamDash = _slicedToArray(_ref7.overallTeamDashboard, 1);
          ...
          (0, _preview2.default)(homeTeam, visitorTeam, _extends({}, seasonMetaData, gameBoxScoreData, {
      ...
      case '2':
        {
          ...
          while (true) {
            ...
            try {
              var _ref8 = yield _nbaStatsClient2.default.getPlayByPlayFromDate(new Date(_date), gameData.id);
            ...
            try {
              var _ref9 = yield _nbaStatsClient2.default.getBoxScoreFromDate(new Date(_date), gameData.id);
            ...
            (0, _live2.default)(homeTeam, visitorTeam, _extends({}, gamePlayByPlayData, seasonMetaData, {
              isFinal
            }), gameBoxScoreData, {
              screen,
              scoreboardTable,
      ...
      default:
        {
          screen.destroy();
          console.log('');
          (0, _scoreboard2.default)(homeTeam, visitorTeam, _extends({}, gameBoxScoreData, seasonMetaData));
          console.log('');
